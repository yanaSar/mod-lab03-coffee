...
int main() {
    ...
    std::cout << "\n=== ТЕСТ 7: Добавление денег и успешная покупка ===" << std::endl;
    ...
    std::cout << "\n=== ТЕСТ 9: Попытка использования после выключения ===" << std::endl;
    coffeeMachine.coin(50);
    
    // 10. Повторное включение и быстрая покупка
    std::cout << "\n=== ТЕСТ 10: Повторное включение и покупка ===" << std::endl;
    coffeeMachine.on();
